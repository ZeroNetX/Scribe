...
void showZeroNetxDialog(BuildContext context, VoidCallback callBack) {
  showDialog(
    context: context,
    builder: (context) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: CertificatesList(callBack: callBack),
                        ),
                      ],
                    ),
                  ),
...
class CertificatesList extends StatefulWidget {
  const CertificatesList({required this.callBack, super.key});
                    ...
                    : selectedUserId!.active
                        ...
                        : !selectedUserId!.registered
                            ...
                            : () async {
                                ...
                                var siteInfo =
                                    await ZeroNet.instance.siteInfoFuture();
                                if (siteInfo.isMsg) {
                                  if (siteInfo
                                          .message!.result['cert_user_id'] !=
                                      null) {
                                    widget.callBack();
                                  }
                                }
